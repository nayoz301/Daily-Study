...
//   //97부터 122까지 = 26개 / 26-secret한 값을 초기 아스키 값에서 빼준다.
//   secret = secret%26;
...
//   for(let i=0;i<str.length;i++){
//     //문자 하나하나를 아스키코드로 변환
//     newArr.push(str.charCodeAt(i)-secret);
//     //아스키코드가 97보다 작은 경우 수정해줘야함
//   }
//   for(let j=0;j<newArr.length;j++){
//     if(newArr[j]<97){
//       newArr[j] = newArr[j]+subtract; 
//       console.log(j)
//     }
//   }
  
//   for(let k=0;k<newArr.length;k++){
//     newArr = String.fromCharCode([newArr[k]]);
//   }
//   let a = newArr.join('')
//   return a;
// }
...
//   for(let i=0;i<str.length;i++){
//     //문자 하나하나를 아스키코드로 변환
//     asciiArr.push(str.charCodeAt(i)-secret);
//     //아스키코드가 122보다 큰 경우 수정해줘야함
//   }
//   for(let j=0;j<asciiArr.length;j++){
//     if(asciiArr[j]>122){
//       asciiArr[j] = asciiArr[j]-subtract;
//     }
//   } //아스키코드 122보다 큰 수는 알파벳26글자에서 secret빼준 만큼 빼준다. 그러면 97-122사이에서 숫자가 돌게됨.
//   asciiArr = asciiArr.map(function(el){
...
//   }//asciiArr 아스키코드만 뽑은 배열

//   //아스키코드에 secret만큼 더해주기
//   asciiArr = asciiArr.map(function(el){
//     return el+secret;
//   }) //각 아스키코드에 secret수 만큼 더한 배열 완성을 다시 asciiArr에 담음.

//   //asciiArr을 다시 글자로 변환한 뒤 join으로 묶어 한 단어로 만들어주기
//   asciiArr = asciiArr.map(function(el){
//     return String.fromCharCode([el]);
//   })
